                ...
                if ($db_found) {
                    ...
                    if (mysqli_num_rows($result) == 0) {
                        ...
                        while ($data = mysqli_fetch_assoc($result)) {
                            ...
                            echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data['id_medecin'] . ">" . $data['nom'] . "</a></td>";
                            echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data['id_medecin'] . ">" . $data['prenom'] . "</a></td>";
                            echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data['id_medecin'] . ">" . $data['type_medecin'] . "</a></td>";
                            echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data['id_medecin'] . ">" . $data['email'] . "</a></td>";
                            echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data['id_medecin'] . ">" . $data['cabinet'] . "</a></td>";
                             $image = $data['photo'];
