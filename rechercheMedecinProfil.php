        ...
        <table class="table table-hover">
            ...
            if ($db_found) {
                ...
                while ($data1 = mysqli_fetch_assoc($result1)) {
                    ...
                    echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data1['id_medecin'] . ">" . $data1['nom'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data1['id_medecin'] . ">" . $data1['prenom'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data1['id_medecin'] . ">" . $data1['type_medecin'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data1['id_medecin'] . ">" . $data1['email'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheMedecinProfil.php?id_medecin=" . $data1['id_medecin'] . ">" . $data1['cabinet'] . "</a></td>";
                    /*
