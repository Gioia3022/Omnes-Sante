        ...
        <table class="table table-hover">
            ...
            if ($db_found) {
                ...
                while ($data3 = mysqli_fetch_assoc($result3)) {
                    ...
                    echo " <td class=nav-item><a class=nav-link href=rechercheLaboProfil.php?id_examen=" . $data3['id_examen'] . ">" . $data3['type_examen'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheLaboProfil.php?id_examen=" . $data3['id_examen'] . ">" . $data4['nom'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheLaboProfil.php?id_examen=" . $data3['id_examen'] . ">" . $data4['adresse'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheLaboProfil.php?id_examen=" . $data3['id_examen'] . ">" . $data4['email'] . "</a></td>";
                    echo " <td class=nav-item><a class=nav-link href=rechercheLaboProfil.php?id_examen=" . $data3['id_examen'] . ">" . $data4['telephone'] . "</a></td>";
                    echo "</tr>";
                }
            } else {
